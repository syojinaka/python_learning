...
# 実行
data_to_commit = [[34.6, 138.0], [34.6, 138.8], [35.4, 138.0], [34.98, 138.1], [35.0, 138.25], [35.4, 137.6], [34.98, 137.521], [34.5, 138.5], [35.4, 138.11]]
...
for data in training_data:
    if data[2] < 0.5:
        ...
        position_tokyo_learning[1].append(data[0] + refer_point_0)  # 緯度
    else:
...
plt.scatter(position_kanagawa_learning[0], position_kanagawa_learning[1], c="blue", label="Tokyo", marker="+")
